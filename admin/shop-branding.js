(() => {
  const BRANDS = {
    ...
    jerry:{ name:"傑瑞電動車", short:"傑瑞電動車", logo:"../jerry/admin-logo.svg", front:"../jerry/" }
  };
  ...
  function installSelector() {
    ...
    selector.innerHTML='<p>請先選擇管理車行</p><div><button type="button" data-shop-choice="xiaoyu"><img src="../assets/brand/logo-round.webp" alt=""><span>小宇微電</span></button><button type="button" data-shop-choice="jerry"><img src="../jerry/admin-logo.svg" alt=""><span>傑瑞電動車</span></button></div><small>登入後仍會依帳號權限自動切換，不會看到其他車行資料。</small>';
